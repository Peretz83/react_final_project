...
import { editUser, getUserById } from "../services/apiServices";
...
const Profile = (props: Props) => {
  ...
  useEffect(() => {
    ...
    getUserById(id as string).then((json) => {
  ...
  return (
    <div className="min-vw-100 min-vh-100 py-4 signupWrap">
      <Title mainText="Profile" />
      <div className="text-center">
        <i style={{ fontSize: "5rem" }} className="bi bi-person-circle" />
      </div>
      <FormLayout>
        ...
        <div className=" mb-3 form-check">
          ...
          />
          <label className="form-check-label">Sign up as a bussiness:</label>
        </div>
